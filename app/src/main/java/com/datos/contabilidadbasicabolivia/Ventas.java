...
public class Ventas extends AppCompatActivity {
    ...
    public void Generar(View view) {
        try {
            ...
            double valor_ventas=valor1*0.87;
            ...
            String venta_String=decimalFormat.format(valor_ventas);
            String debito_String=decimalFormat.format(valor_debito);
            String itpagar_String = decimalFormat.format(valor_itpagar);

            tvcompra.setText(caja_String);
            tvcompras2.setText("");
            tvcredito.setText(it_String);
            tvcredito4.setText("");
            tvcaja5.setText("");
            tvcaja.setText(venta_String);
            debito.setText("");
            debito2.setText(debito_String);
            it.setText("");
            it2.setText(itpagar_String);
            ...
            if(valor1>=50000){
                nota3.setText("Información complementaria: Como contribuyente tienes que saber que la bancarización obliga a las personas y empresas a realizar sus transacciones necesariamente por bancos cuando éstas superen montos mayores a Bs50. 000, desde el 2011");
            }
