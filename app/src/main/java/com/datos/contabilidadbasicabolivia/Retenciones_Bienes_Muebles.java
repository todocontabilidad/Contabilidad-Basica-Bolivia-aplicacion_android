...
public class Retenciones_Bienes_Muebles extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retenciones_bienes_muebles);
    ...
    public void Generar(View view) {
        try {
            ...
            glosa.setText("Glosa: Por la compra de (Bien Mueble) por la suma de: bs "+valor1+"  Realizando la respectiva retención");
