...
public class DevolucionVentas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_devolucion_ventas);
    ...
    public void Generar(View view) {
        try {
            ...
            String devolucion_String = decimalFormat.format(valor_devolucion);
            ...
            tvcredito4.setText("");
            tvcaja5.setText(itpagar_String);
            tvcaja.setText("");
            debito.setText("");
            debito2.setText(caja_String);
            it.setText("");
            it2.setText(it_String);
            //Mensajes para la glosa e informaicón complementaria
            glosa.setText("Glosa: Por la devolución de marcaderias y pago al contado de: bs "+valor1);
